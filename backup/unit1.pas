...
begin
  // Define os formatos específicos
  ...
  // Converte a string para TDateTime usando os formatos definidos
  if TryStrToDateTime(DateTimeStr, DateTime, FormatSettings) then
  begin
    // Formata o TDateTime para o formato brasileiro
    FormatSettings.DateSeparator := '/';
    FormatSettings.ShortDateFormat := 'dd/mm/yyyy';
    Result := DateTimeToStr(DateTime, FormatSettings);
  end
  else
    raise Exception.Create('Formato de data e hora inválido');
end;
